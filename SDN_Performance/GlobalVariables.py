...
SdnBenchmarking project.

Authors: chandralekha.v@happiestminds.com
Edited: by chandralekha
"""
...
ODL_SYSTEM_IP = '10.22.20.88'  # Override if ODL is not running locally to pybot
...
# ONOS system variables
ONOS_SYSTEM_IP = '10.22.20.73'  # Override if ODL is not running locally to pybot
ONOS_SYSTEM_IP_LIST = ['ODL_SYSTEM_1_IP', 'ODL_SYSTEM_2_IP', 'ODL_SYSTEM_3_IP']
ONOS_SYSTEM_USER = DEFAULT_USER
ONOS_SYSTEM_PASSWORD = ''  # empty means use public key authentication
ONOS_SYSTEM_PROMPT = DEFAULT_LINUX_PROMPT

# "Tools" system variables (mininet, cbench etc).
TOOLS_SYSTEM_IP = '10.22.20.177'  # Override if tools are not run locally to pybot
...
#ONOS KARAF Variables
ONOS_KARAF_SHELL_PORT = '8101'
ONOS_ESCAPE_CHARACTER = '\x1B'
ONOS_KARAF_DETAILED_PROMPT = 'onos>'
ONOS_KARAF_USER = 'onos'
ONOS_KARAF_PASSWORD = 'onos'
ONOS_KARAF_PROMPT = 'onos>'
