...
Library           SSHLibrary
Resource          ${CURDIR}/CommonUtils.robot
Resource          ${CURDIR}/../GlobalVariables.robot
...
Run_Keyword_Preserve_Connection
    ...
    [Teardown]    CommonSSHKeywords.Restore_Current_SSH_Connection_From_Index    ${current_connection.index}
