...
def mpls_test():
    ...
    time.sleep(2)
    tx_pkts=driver.find_element_by_xpath("/html/body/div[1]/div/div/div/div/div/table/tbody/tr[3]/td[3]").text
    rx_pkts=driver.find_element_by_xpath("/html/body/div[1]/div/div/div/div/div/table/tbody/tr[3]/td[2]").text
