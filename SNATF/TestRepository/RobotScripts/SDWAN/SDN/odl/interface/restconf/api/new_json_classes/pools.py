...
class INSTANCE(object):
    ...
    def __init__(self):
        self._template = {}
        self._template[self._NAME_FIELD] = None
        self._template[self._PROVIDER_FIELD] = None
        self._default_template = deepcopy(self._template)
        self._REST_URL = None
    ...
    def set_provider(self, value):
        self._template[self._PROVIDER_FIELD] = value
    ...
    def create_instance(self):
        ...
        payload = {self._INSTANCE_FIELD: self.get_template()}
        rest_session.send_post_request(url=self._REST_URL, data=json.dumps(payload))
        return rest_session.response_code, rest_session.response_as_text
...
class SERVICE(object):
    ...
    def __init__(self):
        self._template = {}
        self._template[self._INSTANCE_FIELD] = None
        self._template[self._TYPE_FIELD] = None
        self._default_template = deepcopy(self._template)
        self._REST_URL = None
    ...
    def get_template(self, default=False):
        if default:
            self._default_template[self._INSTANCE_FIELD] = self.instance.get_template(default=default)
            return self._default_template
        else:
            self._template[self._INSTANCE_FIELD] = self.instance.get_template()
            return self._template

    def get_payload(self):
        payload = {key: value for key, value in self._template.iteritems() if value is not None}
        instance_payload = self.instance.get_payload()
        if instance_payload:
            payload[self._INSTANCE_FIELD] = instance_payload
        return payload
    ...
    def create_service(self):
        ...
        payload = {self._SERVICE_FIELD: self.get_template()}
        rest_session.send_post_request(url=self._REST_URL, data=json.dumps(payload))
        return rest_session.response_code, rest_session.response_as_text
