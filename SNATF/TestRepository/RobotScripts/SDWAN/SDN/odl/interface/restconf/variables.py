...
ODL_SYSTEM_IP = '10.22.20.139'  # Override if ODL is not running locally to pybot
ODL_SYSTEM_IP_1 = '10.22.20.139'  # Override if ODL is not running locally to pybot
...
TOOLS_SYSTEM_IP = '10.22.20.104'  # Override if tools are not run locally to pybot
TOOLS_SYSTEM_2_IP= '10.22.20.146'
