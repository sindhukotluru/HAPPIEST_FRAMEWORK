...
def create_local(password):
    ...
    enable_plugin tacker https://github.com/openstack/tacker stable/ocata""" %password
...
def connect_host_configure_iperf3(host):
    k = paramiko.RSAKey.from_private_key_file("/home/testpc/automation/rmaity/test_demo/robot/suite/vnf/loginkey.pem")
    ...
    stdin , stdout, stderr = H.exec_command('yes | sudo apt install iperf3')
    op=stdout.read()
    logging.info("%s"%op)
