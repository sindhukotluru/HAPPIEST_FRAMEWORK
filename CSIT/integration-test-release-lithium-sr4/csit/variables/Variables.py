...
ODL_SYSTEM_IP = '192.168.203.62'  # Override if ODL is not running locally to pybot
ODL_SYSTEM_IP_1 = '192.168.203.62'  # Override if ODL is not running locally to pybot
NUM_ODL_SYSTEM = '192.168.203.62'
...
# OPENSTACK
OPENSTACK = '192.168.203.3'
OS_CONTROL_NODE_IP = '192.168.203.3'
OS_USER = 'test'

# "Tools" system variables (mininet etc).
TOOLS_SYSTEM_IP = '192.168.203.4'  # Override if tools are not run locally to pybot
#TOOLS_SYSTEM_IP = '192.168.203.27'  # Override if tools are not run locally to pybot
TOOLS_SYSTEM_2_IP= '192.168.203.28' 
